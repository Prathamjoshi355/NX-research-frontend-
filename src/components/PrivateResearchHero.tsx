...
export default function PrivateResearchHero() {
  ...
  return (
    <section
      ref={containerRef}
      className="relative min-h-[60dvh] md:min-h-[85dvh] w-full overflow-hidden flex items-center justify-center bg-bg-primary pt-20 pb-10"
    >
      {/* ── Video Container ── */}
      <motion.div
        style={
        ...
        className={
          isPip
            ? // PiP mode — fixed bottom-right, big enough to see
              "fixed bottom-6 right-6 z-50 w-[200px] sm:w-[300px] h-[112px] sm:h-[168px] rounded-2xl overflow-hidden shadow-[0_20px_60px_rgba(0,0,0,0.7)] bg-black"
      ...
      >
        ...
        >
          <source
            src="https://res.cloudinary.com/dhy9pmo8s/video/upload/v1771958486/Private_Research_evtb1r.mp4"
            type="video/mp4"
          />
        </video>
        <AnimatePresence>
          ...
          {isMuted && (
            <>
              <motion.h1
                ...
                animate={{ opacity: 1, y: 0 }}
                exit={{ opacity: 0, y: -20 }}
                className="text-2xl xs:text-3xl sm:text-4xl md:text-[64px] font-display font-black text-text-primary tracking-tighter mb-2 sm:mb-3 leading-tight drop-shadow-[0_0_60px_rgba(0,212,255,0.3)]"
              >
                Private Research
              </motion.h1>
              ...
              <motion.p
                ...
                animate={{ opacity: 1, y: 0 }}
                exit={{ opacity: 0, y: -20 }}
                className="text-base xs:text-lg sm:text-xl md:text-3xl font-display font-normal text-neon-cyan mb-6 sm:mb-8 tracking-[0.15em] sm:tracking-widest drop-shadow-[0_0_30px_rgba(0,212,255,0.6)] px-4"
              >
