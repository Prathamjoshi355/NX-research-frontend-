...
export default function VisionMission() {
  return (
    <section id="vision-mission" className="py-12 md:py-32 bg-gradient-to-b from-bg-secondary to-bg-primary overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="relative grid grid-cols-1 md:grid-cols-2 gap-0">
          ...
          <motion.div
            ...
            className="p-6 sm:p-8 md:p-20 flex flex-col justify-center"
          >
          ...
          >
            ...
            <p className="font-heading font-normal text-text-secondary text-sm sm:text-base leading-relaxed">
