...
export default function Hero({
  ...
  return (
    <section
      ref={containerRef}
      className="relative min-h-[60dvh] sm:min-h-[85dvh] w-full overflow-hidden flex items-center justify-center bg-bg-primary pt-20 pb-10"
    >
      {/* ── Video Container ── */}
      <motion.div
        style={
        ...
        className={
          isPip
            ? // PiP mode — fixed bottom-right, big enough to see
              "fixed bottom-6 right-6 z-50 w-[200px] sm:w-[300px] h-[112px] sm:h-[168px] rounded-2xl overflow-hidden shadow-[0_20px_60px_rgba(0,0,0,0.7)] border border-white/10 group/pip bg-black"
      ...
      >
        ...
        >
          <source
            src="https://res.cloudinary.com/dhy9pmo8s/video/upload/v1772101272/WhatsApp_Video_2026-02-26_at_2.11.58_PM_ufc8wf.mp4"
            type="video/mp4"
          />
        </video>
