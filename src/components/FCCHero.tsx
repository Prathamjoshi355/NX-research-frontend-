        ...
        className={
          isPip
            ? // PiP mode — fixed bottom-right, big enough to see
              "fixed bottom-8 right-8 z-50 w-[240px] sm:w-[300px] h-[135px] sm:h-[168px] rounded-2xl overflow-hidden shadow-[0_20px_60px_rgba(0,0,0,0.7)] border border-white/10 group/pip bg-black"
