...
export default function EmpowermentHero() {
  ...
  return (
    <section className="relative h-[100dvh] w-full overflow-hidden flex items-center justify-center bg-bg-primary">
      {/* Background Video - Different for this page */}
      <motion.div
      ...
      >
        ...
        >
          {/* Using a different video for transformation theme */}
      ...
      <div className="fixed bottom-8 right-8 z-40">
        ...
        <button
          onClick={toggleMute}
          className="relative w-12 h-12 bg-bg-primary/40 backdrop-blur-xl border border-neon-cyan/20 rounded-full flex items-center justify-center text-neon-cyan hover:bg-neon-cyan hover:text-bg-primary transition-all duration-300 group shadow-[0_0_20px_rgba(0,212,255,0.1)] hover:shadow-[0_0_30px_rgba(0,212,255,0.3)]"
        >
          {isMuted ? (
