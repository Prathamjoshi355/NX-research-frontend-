    ...
    <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
      ...
      <div>
        ...
        <ul className="space-y-4 text-blue-100/70 font-medium">
          ...
          <li><Link to="/Mentor" className="hover:text-white transition-colors">Mentors</Link></li>
      ...
      <div>
        ...
        <ul className="space-y-4 text-blue-100/70 font-medium">
          ...
          <li><Link to="/Registration" className="hover:text-white transition-colors">Register for FCC Summit</Link></li>
        </ul>
      </div>
      <div>
