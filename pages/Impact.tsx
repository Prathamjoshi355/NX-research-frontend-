  ...
  return (
    <div className="animate-in fade-in duration-500">
      <Section className="text-center pt-32 pb-44">
        <h1 className="text-6xl md:text-8xl font-black text-[#0A2463] mb-8 leading-[0.85] tracking-tighter uppercase">Outcomes & Impact</h1>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          {IMPACT_METRICS.map((stat, i) => (
            <Card key={i} className="p-10 bg-white border-none shadow-sm rounded-[3rem] text-center">
              <div className="text-[#FB8500] mb-4 flex justify-center"><stat.Icon size={32} /></div>
      ...
      <Section>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-20">
          <div>
            <h2 className="text-4xl font-black text-[#0A2463] uppercase tracking-tighter mb-8">Research Reports</h2>
            <div className="space-y-4">
              {[
                ...
                <div key={i} className="flex justify-between items-center bg-gray-50 p-6 rounded-3xl group cursor-pointer hover:bg-[#0A2463] hover:text-white transition-all">
                  <div>
                  ...
                  <FileText className="text-[#FB8500] group-hover:text-white" />
                </div>
              ))}
            </div>
          </div>
          <Card className="bg-[#FB8500] text-white border-none p-16 rounded-[4rem] flex flex-col justify-center">
            <Trophy className="mb-8 w-16 h-16" />
            <h3 className="text-3xl font-black uppercase mb-6 leading-none">Student Growth Stories</h3>
            <p className="text-orange-50 font-medium text-lg leading-relaxed mb-8">"NX Research didn't just teach me tech, it taught me how to solve. I went from being a student to leading a government project in 6 months."</p>
      ...
      <Section gray className="text-center py-32">
        <h2 className="text-4xl font-black text-[#0A2463] uppercase tracking-tighter mb-8">Global Industry Feedback</h2>
