    ...
    <div className="animate-in slide-in-from-right duration-500">
      ...
      <Section gray className="py-24">
        <div className="flex justify-between items-end mb-16">
          <h2 className="text-4xl font-black text-[#1F2D2B] uppercase tracking-tighter">Current Openings</h2>
          <div className="flex space-x-4">
            <span className="text-[10px] font-black uppercase text-gray-400">Filter:</span>
            <button className="text-[10px] font-black uppercase text-[#3FB998]">All</button>
            <button className="text-[10px] font-black uppercase text-gray-400 hover:text-[#3FB998]">Gov</button>
            <button className="text-[10px] font-black uppercase text-gray-400 hover:text-[#3FB998]">Industry</button>
          </div>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {CHALLENGES.map((challenge) => (
            <Card key={challenge.id} className="p-10 bg-white border-none shadow-sm rounded-[3rem] group hover:bg-[#1F2D2B] hover:text-white transition-all duration-500">
              ...
              <div className="flex items-center space-x-2 text-[#3FB998] font-black text-sm uppercase tracking-widest mb-8">
                <Zap size={16} /> <span>Prize: {challenge.prize}</span>
              </div>
              <Button fullWidth variant="outline" className="group-hover:bg-[#3FB998] group-hover:text-white group-hover:border-[#3FB998]">Participate <ArrowRight size={16} className="ml-2" /></Button>
            </Card>
          ))}
        </div>
      </Section>
      ...
      <Section id="apply">
        <div className="max-w-4xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-20 items-center">
            <div>
              <h2 className="text-4xl font-black text-[#1F2D2B] uppercase tracking-tighter mb-8">Why Participate?</h2>
              <div className="space-y-8">
                {[
                  ...
                  <div key={item.title} className="flex items-start space-x-6">
                    <div className="bg-gray-100 p-4 rounded-2xl text-[#3FB998]"><item.icon size={24} /></div>
                    <div>
                      <h4 className="font-black text-[#1F2D2B] uppercase text-sm mb-1">{item.title}</h4>
            ...
            <div className="bg-white border-2 border-gray-100 rounded-[60px] p-16 shadow-2xl">
              <h3 className="text-2xl font-black text-[#1F2D2B] mb-10 uppercase text-center">Challenge Application</h3>
